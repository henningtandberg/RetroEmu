...
public class BitCountingProgramTest
{
    ...
    [InlineData(0xff, 8)]
    public static void
        BitCountingProgram1_RunWhileStillBitsToCount_AmountOfBitsAreCalculatedCorrectly(byte a, byte expectedValue)
    {
    ...
    [InlineData(0xff, 8)]
    public static void
        BitCountingProgram2_RunWhileStillBitsToCount_AmountOfBitsAreCalculatedCorrectly(byte a, byte expectedValue)
    {
        var gameBoy = TestGameBoyBuilder
           .CreateBuilder()
           .WithProcessor(processor => processor
